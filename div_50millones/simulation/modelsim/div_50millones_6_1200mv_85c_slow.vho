...
ARCHITECTURE structure OF div_50millones IS
...
-- Equation(s):
-- \count1~2_combout\ = (\Add0~12_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count1~1_combout\ = (\Add0~22_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count1~0_combout\ = (\Add0~24_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count1~5_combout\ = (!\Equal0~8_combout\ & \Add0~32_combout\)
...
-- Equation(s):
-- \count1~6_combout\ = (\Add0~36_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count1~7_combout\ = (\Add0~38_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \Equal0~5_combout\ = (count1(18) & (!count1(17) & (count1(16) & count1(19))))
...
-- Equation(s):
-- \count1~8_combout\ = (\Add0~40_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count1~11_combout\ = (!\Equal0~8_combout\ & \Add0~48_combout\)
...
-- Equation(s):
-- \Equal0~7_combout\ = (count1(24) & !count1(25))
...
-- Equation(s):
-- \Equal0~6_combout\ = (!count1(23) & (count1(22) & (count1(21) & count1(20))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!count1(7) & (count1(5) & (!count1(6) & !count1(8))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (count1(13) & (count1(0) & (count1(14) & !count1(15))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (count1(3) & (count1(4) & (count1(2) & count1(1))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (count1(12) & (!count1(10) & (!count1(9) & count1(11))))
